  ...
  return (
    <div className='grid grid-cols-2 m-2 w-full bg-zinc-950 rounded-xl border-1 border-zinc-800 transform hover:scale-102 transition-transform duration-400 ease-in-out shadow-lg '>
     <div className='flex flex-col '>
      ...
      <img src='pro.jpg' className='h-40 w-72 ml-0 lg:ml-4 '/>
      </div>
      <div className='m-2'>
        ...
        <div className='text-lg text-white flex justify-center m-1  hover:bg-zinc-800 py-2 mt-3 rounded-xl bg-zinc-900 border-1 border-zinc-800 items-center'><FaExternalLinkAlt  className="text-amber-500 mr-2" />Code</div>
        <div className='text-lg text-white flex justify-center m-1  hover:bg-zinc-800 py-2 mt-3  rounded-xl bg-zinc-900 border-1 border-zinc-800 items-center'><FaBroadcastTower  className="text-amber-500  mr-2 " />Live</div>
        <div>
